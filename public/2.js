...
/* harmony import */ var primevue_calendar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! primevue/calendar */ "./node_modules/primevue/calendar.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    createUser: function createUser() {
      ...
      this.editMode = false;
      this.$Progress.start();
      _services_UserService__WEBPACK_IMPORTED_MODULE_0__["create"](this.userForm).then(function (response) {
    ...
    editModel: function editModel(id) {
      ...
      this.resetForm();
      this.$Progress.start();
      _services_UserService__WEBPACK_IMPORTED_MODULE_0__["edit"](id).then(function (response) {
    ...
    updateUser: function updateUser() {
      ...
      this.editMode = true;
      this.$Progress.start();
      _services_UserService__WEBPACK_IMPORTED_MODULE_0__["update"](this.userForm.id, this.userForm).then(function (response) {
        _this4.serverErrors = [];
        Fire.$emit('AfterCreate'); //global event emitter
    ...
    loadUsers: function loadUsers() {
      ...
      this.$Progress.start();
      _services_UserService__WEBPACK_IMPORTED_MODULE_0__["users"]().then(function (response) {
    ...
    deleteUser: function deleteUser(id) {
      ...
      Swal2.fire({
        ...
        if (result.value) {
          ...
          _services_UserService__WEBPACK_IMPORTED_MODULE_0__["deleteUser"](id).then(function (response) {
            console.log(response);
            Swal2.fire('Deleted!', response.data.message, 'success');
            Fire.$emit('AfterCreate'); //global event emitter

            _this6.$Progress.finish();
          })["catch"](function (error) {
            //this.serverErrors = error.response.data.errors;
            Swal2.fire('Failed!', 'There was something wrong!', 'warning');
