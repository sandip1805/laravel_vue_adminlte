...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    login: function login() {
      ...
      _services_AuthService__WEBPACK_IMPORTED_MODULE_0__["login"](this.loginForm).then(function (response) {
        ...
        _this2.$store.commit('LoginUser', response.data.data);

        _this2.$store.commit('UserData', response.data.data);
  ...
  mounted: function mounted() {//console.log(this.$store.state.test)
  }
});
